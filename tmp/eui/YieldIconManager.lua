...
local g_cultureTexture = "YieldAtlas_128_Culture_New.dds"
local g_faithTexture = "YieldAtlas_128_Faith_New.dds"
local g_Textures = { [0]=g_defaultTexture, g_defaultTexture, g_defaultTexture, g_defaultTexture, g_cultureTexture, g_faithTexture, "YieldAtlas_128_Tourism.dds", "YieldAtlas_128_GoldenAge.dds" }
