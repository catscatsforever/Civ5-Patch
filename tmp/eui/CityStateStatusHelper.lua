		...
		if minorPlayer then
			for _, questID in pairs(ktQuestsDisplayOrder) do
				...
				if isMinorCivQuestForPlayer( minorPlayer, majorPlayerID, questID ) then
					...
					local turnsRemaining = minorPlayer:GetQuestTurnsRemaining(majorPlayerID, questID, Game_GetGameTurn())	-- add 1 since began on CS's turn (1 before), and avoids "0 turns remaining"
