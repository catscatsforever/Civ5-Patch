...
public:
	...
	int getDevensivePactCount() const;
	void incrementDevensivePactCount();
#endif
...
#ifdef RES_AGR_COUNT
	int getResearchAgreementCount() const;
	void incrementResearchAgreementCount();
	void decrementResearchAgreementCount();
#endif
...
#ifdef DEF_PACT_COUNT
	int m_iDefensivePactCount;
#endif
	int m_iResearchAgreementTradingAllowedCount;
#ifdef RES_AGR_COUNT
	int m_iResearchAgreementCount;
#endif
