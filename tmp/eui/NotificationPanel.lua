...
-- todo reset finger animation - requires style modification
		...
		elseif type == 1001 or type == 1002 or type == 1003 then
			...
			itemInfo = GameInfo.Civilizations[Players[playerID]:GetCivilizationType()]
			itemImage = instance.MPVotingSystemProposalImage
			smallCivFrame = instance.SmallCivFrame
			if type == 1001 then
			...
			return CivIconHookup( playerID, 45, instance.MPVotingSystemProposalAlphaAnim, instance.CivIconBG, instance.CivIconShadow, false, true );
