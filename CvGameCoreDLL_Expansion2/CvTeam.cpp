...
#ifdef DEF_PACT_COUNT
//	--------------------------------------------------------------------------------
int CvTeam::getDevensivePactCount() const
{
	return m_iDefensivePactCount;
}
//	--------------------------------------------------------------------------------
void CvTeam::incrementDevensivePactCount()
{
	m_iDefensivePactCount++;
}
#endif
//	--------------------------------------------------------------------------------
...
#ifdef RES_AGR_COUNT
//	--------------------------------------------------------------------------------
int CvTeam::getResearchAgreementCount() const
{
	return m_iResearchAgreementCount;
}
//	--------------------------------------------------------------------------------
void CvTeam::incrementResearchAgreementCount()
{
	m_iResearchAgreementCount++;
}
//	--------------------------------------------------------------------------------
void CvTeam::decrementResearchAgreementCount()
{
	if (m_iResearchAgreementCount > 0)
		m_iResearchAgreementCount--;
}
#endif
//	--------------------------------------------------------------------------------
