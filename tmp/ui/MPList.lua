...
function OnKickPlayer( selectionIndex )
	...
	-- seems any call to UIManager breaks MPList, so lets call UI.AddPopup instead with special value (Data1 = -2)
	UI.AddPopup({Type = ButtonPopupTypes.BUTTONPOPUP_CONFIRMCOMMAND, Data1 = -2, Data2 = playerID})
